Algoritmo BoletaPagoDocentesssss
	...
	Escribir "Ingrese las horas extras nocturnas trabajadas en feriados o domingos"
	Leer horasNocturnas
	Escribir "Ingrese las horas extras diurnas trabajadas en feriados o domingos"
	Leer horasDiurnas
